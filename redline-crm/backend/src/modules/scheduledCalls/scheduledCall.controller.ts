...
export const getScheduledCallsByContact = async (req: Request, res: Response) => {
  try {
    const calls = await scheduledCallService.getByContactId(req.params.contactId);
...
export const createScheduledCall = async (req: Request, res: Response) => {
  try {
    const call = await scheduledCallService.create(req.body);
...
export const updateScheduledCall = async (req: Request, res: Response) => {
  try {
      const call = await scheduledCallService.update(req.params.id, req.body);
...
export const deleteScheduledCall = async (req: Request, res: Response) => {
    try {
        const success = await scheduledCallService.delete(req.params.id);
